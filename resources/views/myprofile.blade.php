                    ...
                    <!-- Name -->
                        ...
                        <!-- Gender -->
                            <div>
                                ...
                                <x-input id="information" class="block mt-1 w-full" type="text" name="information" value="{{ $user->information }}" required autofocus />
                            </div>
                        ...
                        <div>
                            ...
                            <x-input id="age" class="block mt-1 w-full" type="text" name="age" value="{{ $user->age }}" required autofocus />
                        </div>
                        </div>
                        <div class="grid grid-rows-2 gap-6">
                        <!-- Location -->
                        <div>
                            ...
                            <x-input id="location" class="block mt-1 w-full" type="text" name="location" value="{{ $user->location }}" required autofocus />
                        </div>
                            <div>
                                ...
                                <x-input id="gender" class="block mt-1 w-full" type="radio" name="gender" value="female" />
